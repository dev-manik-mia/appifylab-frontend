    ...
    <div className="_layout_left_sidebar_wrap">
      <div className="_layout_left_sidebar_inner">
        <div className="_left_inner_area_explore _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          <ul className="_left_inner_area_explore_list">
            ...
            <li className="_left_inner_area_explore_item">
              <Link href="/friends" className="_left_inner_area_explore_link">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
            ...
            <li className="_left_inner_area_explore_item">
              <Link href="/settings" className="_left_inner_area_explore_link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  <path fill="#666" d="M12 1.5a10.5 10.5 0 100 21 10.5 10.5 0 000-21zm1.5 7a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zm-1.5 4.5a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" />
                </svg>Settings
              </Link>
            </li>
            <li className="_left_inner_area_explore_item">
        ...
        <div className="_left_inner_area_suggest _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          <div className="_left_inner_area_suggest_content _mar_b24">
            ...
            <span className="_left_inner_area_suggest_content_txt">
              <Link className="_left_inner_area_suggest_content_txt_link" href="/suggested">See All</Link>
            </span>
          </div>
          {[
            ...
            <div className="_left_inner_area_suggest_info" key={person.name}>
              ...
              <div className="_left_inner_area_suggest_info_link">
                <button className="_info_link" onClick={(e) => e.preventDefault()}>Connect</button>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="_layout_left_sidebar_inner">
        <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          {[1, 2].map((i) => (
            <Link className="_left_inner_event_card_link" href="/events" key={i}>
