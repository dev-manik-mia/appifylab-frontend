        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="_header_nav_profile" ref={profileRef}>
            ...
            <div className="_header_nav_dropdown">
              <p className="_header_nav_para">{user ? `${user.first_name} ${user.last_name}` : 'Loading...'}</p>
              <button
              ...
              <div id="_prfoile_drop" className="_nav_profile_dropdown _profile_dropdown" style={{ display: 'block' }}>
                <div className="_nav_profile_dropdown_info">
                  ...
                  <div className="_nav_profile_dropdown_info_txt">
                    <h4 className="_nav_dropdown_title">{user ? `${user.first_name} ${user.last_name}` : ''}</h4>
