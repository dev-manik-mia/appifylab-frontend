        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item" ref={notifyRef}>
              <span id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" onClick={() => setShowNotify(!showNotify)}>
                ...
                <div id="_notify_drop" className={showNotify ? '_notification_dropdown show' : '_notification_dropdown'}>
                    ...
                    <div className="_notifications_all">
                      <div className="_notification_box">
                        <div className="_notification_image">
                          <img src="/assets/images/friend-req.png" alt="Request notification" className="_notify_img" />
                        </div>
                      ...
                      <div className="_notification_box">
                        <div className="_notification_image">
                          <img src="/assets/images/profile-1.png" alt="Notification" className="_notify_img" />
                        </div>
                        <div className="_notification_txt">
                          <p className="_notification_para">
          ...
          <div className="_header_nav_profile" ref={profileRef}>
            ...
            <div className="_header_nav_dropdown">
              ...
              <button id="_profile_drop_show_btn" className="_header_nav_dropdown_btn _dropdown_toggle" type="button" onClick={() => setShowProfile(!showProfile)}>
                    ...
                    <div className="_nav_drop_info">
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" fill="none" viewBox="0 0 18 19">
                          <path fill="#377DFF" d="M9 0a9 9 0 100 18A9 9 0 009 0zm0 2.5a6.5 6.5 0 110 13 6.5 6.5 0 010-13zm0 2a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm0 5a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" />
                        </svg>
                      </span>
                      Settings
                    </div>
